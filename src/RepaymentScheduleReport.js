...
function RepaymentScheduleReport() {
  ...
  const [installment_number, setinstallment_number] = useState("");
  ...
  const RepaymentScheduleRepPermissions = permissions
    .filter((permission) => permission.screen_type === "RepaymentScheduleRep")
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/GetRepaymentScheduleReport`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const generateReport = () => {
    ...
    const reportData = selectedRows.map((row) => {
      ...
      return {
        ...
        "Principal Amount": formatValue(row.principal_amount),
        "Interest Amount": formatValue(row.interest_amount),
        "Payment Status": formatValue(row.payment_status),
      };
    });
    ...
    reportWindow.document.write("<html><head><title>Repayment Schedule Report</title>");
    ...
    reportWindow.document.write(`
        <div class="header">
            ...
            <div class="title-section">
              <h2>Repayment Schedule Report</h2>
            </div>
            </div>`);
  ...
  const exportToPDF = () => {
    ...
    loadImage(logoUrl, (logoBase64) => {
      ...
      doc.text("Repayment Schedule Report", pageWidth / 2, 35, { align: "center" });
      ...
      doc.save("Repayment_Schedule_Report.pdf");
    });
  };
  ...
  const handleExportToExcel = () => {
    ...
    const screenName = "Repayment Schedule Report";
    ...
    XLSX.writeFile(workbook, "Repayment_Schedule_Report.xlsx");
  };
    ...
    <div className="container-fluid Topnav-screen">
      ...
      <div className="shadow-lg p-1 bg-light rounded main-header-box">
        <div className="header-flex">
          <h1 className="page-title">Repayment Schedule Report</h1>

          <div className="action-wrapper desktop-actions">
            {["all permission", "view"].some((p) => RepaymentScheduleRepPermissions.includes(p)) && (
              <div className="action-icon print" onClick={generateReport}>
                <span className="tooltip">Print</span>
                <i className="fa-solid fa-print"></i>
              </div>
            )}
            {["all permission", "PDF"].some((p) => RepaymentScheduleRepPermissions.includes(p)) && (
              <div className="action-icon print" onClick={exportToPDF}>
                <span className="tooltip">Pdf</span>
                <i className="fa-solid fa-file-pdf"></i>
              </div>
            )}
            {["all permission", "Excel"].some((p) => RepaymentScheduleRepPermissions.includes(p)) && (
        ...
        <div className="row g-3">
          ...
          <div className="col-md-2">
            <div
              ...
              title="Please enter the Payment Status"
            >
              <Select
                id="country"
                type="text"
