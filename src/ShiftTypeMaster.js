...
function ShiftTypeMaster() {
  ...
  const handleExportToExcel = () => {
    ...
    const screenName = "Shift Type Master Search Report";
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Shift Type Master");

    XLSX.writeFile(workbook, "Shift_Type_Master_Search_Report.xlsx");
  };
