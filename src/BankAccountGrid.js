...
function BankAccGrid() {
  ...
  const generateReport = () => {
    ...
    reportWindow.document.write("<html><head><title>Bank Accounts Report</title>");
    ...
    // reportWindow.document.write("<h1><u>Bank Accounts Reports</u></h1>");
        ...
        <div className="row g-3">
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={18}
              />
              <label for="cuscode" className="exp-form-labels">Code</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={250}
              />
              <label for="cusname" className="exp-form-labels">Name</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={250}
              />
              <label for="cusaddr1" className="exp-form-labels">Address</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={100}
              />
              <label for="cusarcode" className="exp-form-labels">City</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={100}
              />
              <label for="cusstatcode" className="exp-form-labels">State</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={100}
              />
              <label for="cuscountrycode" className="exp-form-labels">Country</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            ...
            >
              ...
              />
              <label className="floating-label">Account Type</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                maxLength={20}
              />
              <label for="contactno" className="exp-form-labels">Branch</label>
            </div>
          </div>
