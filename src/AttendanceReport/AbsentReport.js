...
function AbsentReport() {
    ...
    const generateReport = () => {
        ...
        const reportData = selectedRows.map((row) => {
            ...
            return {
                "Absent Date": formatValue(row.AbsentDate),
        ...
        reportWindow.document.write("<html><head><title>Absent Report</title>");
    ...
    loadImage(logoUrl, (logoBase64) => {
        ...
        doc.text("Absent Report", pageWidth / 2, 35, { align: "center" });
        ...
        const headers = [
            columnDefs
                .filter(col => col.field && !col.checkboxSelection)
        ...
        doc.save("Absent_Report.pdf");
    });
};

    const transformRowData = (data) => {
        return data.map((row) => ({
            "Absent Date": row.AbsentDate || "",
    ...
    const handleExportToExcel = () => {
        ...
        const screenName = "Absent Report";
        ...
        XLSX.writeFile(workbook, "Absent_Report.xlsx");
    };
        ...
        <div className="container-fluid Topnav-screen">
            ...
            <div className="shadow-lg p-1 bg-light rounded main-header-box">
                <div className="header-flex">
                    <h1 className="page-title">Absent Report</h1>
