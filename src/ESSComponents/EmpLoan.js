          ...
          <div className="col-md-2">
            ...
            >
              <Select type="text"
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
              />
              <label className="floating-label">Loan ID</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input type="number"
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
              />
              <label className="exp-form-labels">Loan Eligible Amount</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
              />
              <label className="exp-form-labels">Effetive Date</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input type="number"
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
              />
              <label for="cname" className="exp-form-labels">How Many Months</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input type="number"
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
              />
              <label for="cname" className="exp-form-labels">EMI Amount</label>
            </div>
          </div>
