...
function Input({ }) {
  ...
  const payslipEmpProTaxPermissions = permissions
    .filter(permission => permission.screen_type === 'PayslipEmpProTax')
      ...
      <div className="shadow-lg p-1 bg-light rounded main-header-box">
        <div className="header-flex">
          ...
          <div className="action-wrapper desktop-actions">
            {['add', 'all permission'].some(permission => payslipEmpProTaxPermissions.includes(permission)) && (
          ...
          <div className="dropdown mobile-actions">
            ...
            <ul className="dropdown-menu dropdown-menu-end text-center">
              {['add', 'all permission'].some(p => payslipEmpProTaxPermissions.includes(p)) && (
                <li>
