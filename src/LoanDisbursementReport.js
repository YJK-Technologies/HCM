...
function LoanDisbursementRepo() {
  ...
  const loanDisbursementRepoPermissions = permissions
    .filter((permission) => permission.screen_type === "LoanDisbursementRepo")
  ...
  const generateReport = () => {
    ...
    const reportData = selectedRows.map((row) => {
      ...
      return {
        ...
        "Paid Amount": formatValue(row.total_paid),
    ...
    reportWindow.document.write("<html><head><title>Loan Disbursement Report</title>");
  ...
  const exportToPDF = () => {
    ...
    loadImage(logoUrl, (logoBase64) => {
      ...
      doc.text("Loan Disbursement Report", pageWidth / 2, 35, { align: "center" });
      ...
      doc.save("Loan_Disbursement_Report.pdf");
    });
  };
  ...
  const handleExportToExcel = () => {
    ...
    const screenName = "Loan Disbursement Report";
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Loan Disbursement Report");
      ...
      <div className="shadow-lg p-1 bg-light rounded main-header-box">
        <div className="header-flex">
          ...
          <div className="action-wrapper desktop-actions">
            {["all permission", "view"].some((p) => loanDisbursementRepoPermissions.includes(p)) && (
              <div className="action-icon print" onClick={generateReport}>
                <span className="tooltip">Print</span>
                <i className="fa-solid fa-print"></i>
              </div>
            )}
            {["all permission", "PDF"].some((p) => loanDisbursementRepoPermissions.includes(p)) && (
              <div className="action-icon print" onClick={exportToPDF}>
                <span className="tooltip">Pdf</span>
                <i className="fa-solid fa-file-pdf"></i>
              </div>
            )}
            {["all permission", "Excel"].some((p) => loanDisbursementRepoPermissions.includes(p)) && (
