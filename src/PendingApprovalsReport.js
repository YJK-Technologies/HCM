...
function PendingApprovalsReport() {
  ...
  const pendingApprovalsRepoPermissions = permissions
    .filter((permission) => permission.screen_type === "PendingApprovalsRepo")
  ...
  const generateReport = () => {
    ...
    const reportData = selectedRows.map((row) => {
      ...
      return {
        ...
        "Approval Level": formatValue(row.approval_level),
        "Approval Date": formatValue(row.approval_date),
        "Approval Status": formatValue(row.approval_status),
      };
    });
    ...
    reportWindow.document.write("<html><head><title>Pending Approvals Report</title>");
    ...
    reportWindow.document.write(`
        <div class="header">
            ...
            <div class="title-section">
              <h2>Pending Approvals Report</h2>
            </div>
            </div>`);
  ...
  const exportToPDF = () => {
    ...
    loadImage(logoUrl, (logoBase64) => {
      ...
      doc.text("Pending Approvals Report", pageWidth / 2, 35, { align: "center" });
  ...
  const handleExportToExcel = () => {
    ...
    const screenName = "Pending Approvals";
      ...
      <div className="shadow-lg p-1 bg-light rounded main-header-box">
        <div className="header-flex">
          ...
          <div className="action-wrapper desktop-actions">
            {["all permission", "view"].some((p) => pendingApprovalsRepoPermissions.includes(p)) && (
            ...
            {["all permission", "PDF"].some((p) => pendingApprovalsRepoPermissions.includes(p)) && (
            ...
            {["all permission", "Excel"].some((p) => pendingApprovalsRepoPermissions.includes(p)) && (
