...
const EmployeeCompOff = () => {
  ...
  const handleSave = async (e) => {
    ...
    if (!compOff || !Reason || !ReportingManager) {
      setError(true);
    ...
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/compOffRequestInsert`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleCompOffSearch = async () => {
    ...
    try {
      const response = await fetch(
        `${config.apiBaseUrl}/compOffSearchCriteria`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="row g-3">
          <div className="col-md-3">
            ...
            >
              ...
              />
              <label
                className={`floating-label ${error && !compOff ? "text-danger" : ""}`}
              >
          ...
          <div className="col-md-12">
            <div className="inputGroup">
              ...
              />
              <label
                className={`exp-form-labels ${error && !Reason ? "text-danger" : ""}`}
              >
          ...
          <div className="col-md-6">
            ...
            >
              ...
              />
              <label
                className={`floating-label ${error && !ReportingManager ? "text-danger" : ""}`}
              >
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                autoComplete="off"
              />
              <label className={`exp-form-labels`}>Holiday From Date</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                autoComplete="off"
              />
              <label className={`exp-form-labels`}>Holiday To Date</label>
            </div>
          </div>
          ...
          <div className="col-md-2">
            <div className="inputGroup">
              <input
                ...
                autoComplete="off"
              />
              <label className={`exp-form-labels`}>Holiday Name</label>
            </div>
          </div>
